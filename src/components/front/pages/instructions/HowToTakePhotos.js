...
export default props => {
    let metaTitle = "Как да снимаме процеса на установяване на резултатите | Ти Броиш";
    ...
    return(
        <Wrapper>
			...
			<h1>КАК ДА СНИМАМЕ ПРОЦЕСА НА УСТАНОВЯВАНЕ НА РЕЗУЛТАТИТЕ</h1>
                <hr/>
                <p>
                    Всеки защитник на вота може да видеозаснема и да видеоизлъчва процеса на установяване на резултатите от гласуването в секцията, в която се намира.
Видеозаснемането и видеоизлъчването започва след края на изборния ден, когато в секцията няма останали избиратели.
                </p>
                <p>
                    Може да се извършва единствено в изборното помещение и в помещението на районната избирателна комисия. Не може да се заснемат избирателните списъци. 
Видеозаснемането и видеоизлъчването обхваща:
                </p>
                <ul>
                    <li>
