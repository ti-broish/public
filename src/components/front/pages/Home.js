  ...
  return [
    ...
    <LandingPage>
      ...
      >
        <LandingPageOverlay>
          ...
          <MiddleSection>
            <p id="text3">
              търсим <b>12 000</b> пазители на вота
            </p>
            <p id="text4">
    ...
    <Wrapper>
      <MainContent>
        ...
        <p>
          Този път, за да гарантираме честността на вота, търсим 12 000 души,
        ...
        <p>
          ...
          000 пазители на вота, членове на СИК или застъпници - по един за всяка
