...
export default props => {
    ...
    return ([
        ...
        <Wrapper>
            ...
            <p>
                „Ти броиш“ е национална кампания, целяща да предотврати опитите за измами и манипулации в изборния ден на предстоящите парламентарни избори. 
                След успеха на последната кампания и най-скорошните изменения в Изборния кодекс, "Ти Броиш" порасна!

            </p>
            <p>
                Този път, за да гарантираме честността на вота, търсим 12 000 души, колкото са изборните секции в страната, които да станат членове на Секционни избирателни комисии или застъпници и да проследят коректното протичане на изборния процес.
            </p>
            <HomeButtonWrapper>
                <Link to='/about'><HomeButton>Научи повече</HomeButton></Link>
            </HomeButtonWrapper>
            <hr/>
            <h2>Търсим 12 000 пазители на вота</h2>
            <p>
                За да дадем на България шанс за честни и свободни избори, търсим 12 000 пазители на вота, членове на СИК или застъпници - по един за всяка секция в страната. 
От ангажимент за 1 ден важи бъдещето на страната за следващите 4 години. 
Можем да го направим заедно!  
            </p>
            <p>
                Запишете се днес и с наближаването на изборния ден ще се свържем с вас, за да ви въведем в кампанията! 
            </p>
            <HomeButtonWrapper>
                <Link to='/signup'><HomeButton>Запиши се тук</HomeButton></Link>
            </HomeButtonWrapper>
            ...
            <p>
                Един от начините на станете пазител на вота е като се запишете за член на Секционна избирателна комисия (СИК). 
Членовете на СИК са главните участници в организирането на изборния процес във всяка секция. Те следят за спазване на разпоредбите на Изборния кодекс и методическите указания на ЦИК в изборното помещение, като осигуряват свободното протичане на гласуването.

            </p>
            <p>
                След края на изборния ден преброяват гласовете от хартиените бюлетини (ако има такива) и вписват данните в протокола, който предоставят на Централната избирателна комисия (ЦИК) заедно с протокола от машинното гласуване.
            </p>
            <p>
                Ангажиментът е овъзмезден, като размерът на сумата варира според населеното място и големината на секцията.
            </p>
            <HomeButtonWrapper>
            ...
            <p>
                Пазителите на вота (или т.нар. „застъпници“) имат право да присъстват в изборното помещение 
