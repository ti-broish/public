    ...
    return(
        <Wrapper>
            ...
            <MainContent>
                ...
                <p>
                    След успеха на последната кампания и най-скорошните изменения в Изборния кодекс, "Ти Броиш" порастна! 
Този път, за да гарантираме честността на вота, търсим 12 000 души, колкото са изборните секции в страната, които да станат членове на Секционни избирателни комисии (СИК) или застъпници и да проследят коректното протичане на изборния процес. 
                </p>
                <p>
                    Според изборното законодателство членовете на СИК следят за спазване на разпоредбите на Изборния кодекс и методическите указания на ЦИК в изборното помещение, като осигуряват свободното протичане на гласуването.

                </p>
                <p>
                    Застъпниците, от друга страна, имат право да присъстват при броенето на бюлетините (ако има такива) и да получат копие от протокола на изборната секция, което да снимат и качат в специално създаденото мобилно приложение "Ти Броиш". Така нашият паралелен преброителен център ще може да обработи резултатите и да ги качи в реално време на сайта ни.

                </p>
                <p>
                    Искаме всеки български гражданин да може да види реалните резултати от изборите, преди те да са стигнали до Централната избирателна комисия, преди да са претърпели неправомерни промени и манипулации.
                </p>
                <hr/>
                ...
                <p>
                    Опитът ни показва, че изборният процес често е подложен на големи манипулации, извършвани преди, по време на и след края на изборния процес, броенето на гласовете и попълването на протоколите.
                </p>
                <p>
                    След промените в Изборния кодекс, осъществени през краткия живот на 45-ото Народно събрание, в секциите с над 300 гласоподаватели бе въведен 100% машинен вот. Това улеснява работата на застъпниците, на които няма да се налага да контролират броенето на огромен брой хартиени бюлетини, но прави отговорността на Секционната избирателна комисия още по-голяма.
                </p>
                <p>
                    Разчитаме на вашата подкрепа, за да осигурим членове на СИК с висок морал и желание да гарантират честността на вота! 
                </p>
                <hr/>
                <h2>Как да стана член на СИК?</h2>
                <p>
                    Формата за записване е отворена за регистрация - <a href="https://tibroish.bg/signup">ЗАПИШИ СЕ</a>. 
                От вас се изисква само да попълните необходимите данни и да бъдете силно мотивирани да станете гарант на честните избори в България, а ние ще се погрижим да се свържем с вас с наближаването на изборния ден във връзка с вашето разпределение! 
                </p>
                <hr/>
                ...
                <p>
                    Ако сте решили да бъдете пазител на вота под формата на член на СИК, трябва да отидете в изборната секция преди началото на изборния ден и да останете до неговия край, както и да следите за спазването на Изборния кодекс и методическите указания на ЦИК. 
                </p>
                <p>
                    Ако сте решили да бъдете пазител на вота под формата на застъпник, достатъчно е да отидете в изборната секция, в която ще гарантирате честното преброяване на гласовете, един час преди тя да затвори. 
                </p>
                <p>
                ...
                <p>
                    Всеки български гражданин, който иска да стане гарант за честни и свободни избори. Всеки, който вярва, че България може много повече, е добре дошъл!
                </p>
                <p>
                    Не е необходимо да сте член на някоя от партиите в „Демократична България“, за да се включите. Все пак, имайте предвид, че националната кампания „Ти броиш“ се организира от „Демократична България - обединение“ и формалната Ви роля ще бъде на наш член на СИК или застъпник. 
                </p>
                <hr/>
                ...
                <p>
                    До края на май ще се свържем с вас във връзка с вашето разпределение като член на СИК, а до края на юни ще се реализира и разпределението на застъпниците.
                </p>
                <hr/>
