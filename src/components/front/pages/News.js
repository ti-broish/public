    ...
    return(
        <Wrapper>
            ...
            <MainContent>
                ...
                <p>
                    Всеки защитник на вота ще се легитимира в изборната секция със специално издаден документ
                    за застъпник, както и с бадж с определени от ЦИК (Централна избирателна комисия) формат и размери.
                </p>
                <hr/>
                ...
                <p>
                    ...
                    кутии и при установяване на резултатите от вота, както и да получат право на пряка 
